...
VALUES
    (1, 819, '16:00', '12:00', 25996, '서초구, 서울, 한국', '강남역 5번 출구에서 도보로 이동가능합니다 지하철, 버스 노선이 다양하고 맛집, 마트등 주변 시설이 풍부합니다. 깨끗하고, 아늑한 시설',
     ...
     'Spacious and Comfortable cozy house #1', 'POINT(127.03029 37.49784)', 71466, 4.8, 127, 1, 1, 3, 'PENSION' ,8188);
...
VALUES
    (2, '숙소 이름1', '숙소1의 상세설명', '서울시 서초구 양재동', '50000', '10000', '5000', '4.80', '40', '1', '1', '4', '500', 'POINT(127.03029 37.49784)'),
    (3, '숙소 이름2', '숙소2의 상세설명', '서울시 서초구 양재동', '30000', '10000', '5000', '4.80', '40', '1', '1', '4', '500', 'POINT(127.03029 37.49784)'),
    (4, '숙소 이름3', '숙소3의 상세설명', '서울시 서초구 양재동', '20000', '10000', '5000', '4.80', '40', '1', '1', '4', '500', 'POINT(127.03029 37.49784)'),
    (5, '숙소 이름4 except 양재', '숙소4의 상세설명', '서울시 종로구 부암동', '50000', '10000', '5000', '4.80', '40', '1', '1', '4', '500', 'POINT(127.03029 37.49784)');
